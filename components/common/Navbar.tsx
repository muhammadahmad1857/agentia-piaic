...
const Navbar = () => {
  ...
  return (
    <div className="max-w-screen overflow-x-hidden">
      <div className=" fixed  h-[80px] z-[500] top-0 left-0 right-0 backdrop-blur-lg bg-black/50 justify-between px-4 py-2 items-center">
        <div className="max-w-2xl flex max-h-full 2xl:mx-auto min-w-full 2xl:w-full  justify-between items-center">
          <Logo slideText />
